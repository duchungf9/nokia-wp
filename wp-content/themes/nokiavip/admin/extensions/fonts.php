...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Text Fonts', 'saha' ) ) ) );
	$text_fonts     = customizer_library_get_text_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'saha' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'saha' ),
		'cyrillic'     => __( 'Cyrillic', 'saha' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'saha' ),
		'devanagari'   => __( 'Devanagari', 'saha' ),
		'greek'        => __( 'Greek', 'saha' ),
		'greek-ext'    => __( 'Greek Extended', 'saha' ),
		'khmer'        => __( 'Khmer', 'saha' ),
		'latin'        => __( 'Latin', 'saha' ),
		'latin-ext'    => __( 'Latin Extended', 'saha' ),
		'vietnamese'   => __( 'Vietnamese', 'saha' ),
	);
}
endif;
...
function customizer_library_get_text_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'saha' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'saha' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'saha' ),
