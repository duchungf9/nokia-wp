...
add_filter( 'hybrid_attr_entry-comment',   'hybrid_attr_entry_comment',   5    );
 ...
 * @return array
 */
function hybrid_attr_entry_comment( $attr ) {
 ...
 * @return array
 */
function saha_entry_markup( $classes ) {
...
add_filter( 'post_class', 'saha_entry_markup' );
 ...
 * @return string
 */
function saha_comments_popup_link_attributes( $attr ) {
	return ' itemprop="discussionURL"';
}
add_filter( 'comments_popup_link_attributes', 'saha_comments_popup_link_attributes', 5 );
 ...
 * @return string
 */
function saha_get_avatar( $avatar ) {
	return preg_replace( '/(<img.*?)(\/>)/i', '$1itemprop="image" $2', $avatar );
}
add_filter( 'get_avatar', 'saha_get_avatar', 5 );
 ...
 * @return array
 */
function saha_img_attr( $attr ) {
    $attr['itemprop'] = 'image';
    return $attr;
}
add_filter( 'wp_get_attachment_image_attributes', 'saha_img_attr', 10, 2 );