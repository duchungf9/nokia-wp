 ...
 * @since      1.0.0
 */
class Saha_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-saha-ad ad-widget',
			'description' => __( 'Easily to display any type of ad.', 'saha' )
		);

		// Create the widget.
		parent::__construct(
			'saha-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'saha' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'   => esc_html__( 'Advertisement', 'saha' ),
			'ad_code' => '',
		);
